...
object GeneralOrdersMockData {
    val orders = listOf(
        ...
        GeneralOrder("PLA-9102", "Cardume Livre", GeneralOrderType.Plans, GeneralOrderStatus.Pending, "R$ 19,90", "18 JUN • 13:22", "Renovação de plano aguardando confirmação."),
        GeneralOrder("LOJ-1660", "Caneca Cardume", GeneralOrderType.Store, GeneralOrderStatus.Cancelled, "R$ 49,90", "26 JUN • 09:40", "Pedido cancelado pelo estoque."),
    )
